    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.content}>
          ...
          <View>
          <Text style={styles.titleText}>HORÁRIOS MARCADOS</Text>
          <LinearGradient
              colors={['#d737b3', '#ae45ac', '#8154a7']}
              ...
              <View style={styles.profileView}>
                <Image
                  style={styles.profilePic}
                  source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSSq7eDvrVchpRF4IUrhmDG25F-jOc35GydVFueOgIZvSggMImV'}}
                />
              </View>
            ...
            <View style={styles.profileView}>
              <Image
                style={styles.profilePic}
                source={{uri: 'http://thinkpynk.com/wp-content/uploads/2015/03/ebonyyy1.jpg'}}
              />
            </View>
            <View style={styles.profileInfo}>
              <View style={styles.profileInfoRow}>
          ...
          <View style={styles.banner}>
            <View style={styles.profileView}>
              <Image
                style={styles.profilePic}
                source={{uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSIuVqMFp6jMvlTesT4xG4aCRaS8Ns3b11k3fgbdHgXhmY_o08c'}}
              />
            </View>
            <View style={styles.profileInfo}>
              <View style={styles.profileInfoRow}>
